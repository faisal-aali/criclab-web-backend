...
GREETINGS = [
    "Hey! 👋 I'm the CricLab AI Assistant. How can I help you today?",
    "Hi there! I'm the CricLab AI Assistant — ask me anything about filming, your results, or booking a session.",
    "Hello! What can I help you with on CricLab today?",
]
THANKS = [
