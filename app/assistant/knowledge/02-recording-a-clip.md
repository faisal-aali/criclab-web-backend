# Filming a clip CricLab can read
...
enough back that the whole run-up, the delivery stride and the ball's first
bounce are all in frame. Roughly ten to fifteen metres to the side works well.

Avoid filming from directly behind the bowler. From there the ball travels away
from the camera and barely moves across the frame, so speed and flight cannot be
measured. It is the single most common reason a clip comes back with missing
numbers.
...
- A white ball against a white sightscreen, or a red ball against dark netting,
  are the hard cases. Change the angle slightly if you can.

## What to include

Start recording a couple of seconds before the run-up begins and keep going
until after the ball has bounced. One delivery per clip.
